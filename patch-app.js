...
const loadSendEventsOld = `const loadSendEvents = async (sendId: string) => {
...
// Update rendering
const eventsPanelOld = `<div data-testid={\`send-events-\${send.id}\`} style={{ marginTop: '0.5rem', padding: '1rem', border: '1px solid #ccc', backgroundColor: '#fafafa' }}>
                    <h4>Event History</h4>
