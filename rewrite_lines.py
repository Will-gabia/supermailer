...
with open('apps/management-console/src/client/App.tsx') as f:
    lines = f.readlines()

new_body = """              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                        <li>
                          <button
                            ...
                            className={`w-full text-left p-3 flex justify-between items-center ${!selectedGroupId ? 'bg-blue-50' : 'hover:bg-gray-50'}`}
                ...
                <div className="col-span-3 flex flex-col gap-4">
                  <div className="card">
                    ...
                    <div className="card-body p-0 flex p-4 gap-6 bg-gray-50" style={{ background: 'var(--bg-main)', borderBottom: '1px solid var(--border-light)', padding: '1rem', display: 'flex', gap: '1.5rem' }}>
                      {(() => {
                    ...
                    {subscriberActionError && (
                      <div className="p-4 text-error" style={{ color: 'var(--color-error)', padding: '1rem', borderBottom: '1px solid var(--border-light)' }}>
                        {subscriberActionError}
                      </div>
                    )}
...
# The indices are 0-based, so line 1324 is index 1323.
# Line 1673 is index 1672.
start_idx = 1323
end_idx = 1673
